...
### 優先度: 低（Phase 3 - Sanity法令解説）

> 詳細は [docs/SANITY_REQUIREMENTS.md](./docs/SANITY_REQUIREMENTS.md) 参照

- [ ] Sanity CMS 導入
- [ ] 法令解説ページ（2カラム: 日本語/原文）
- [ ] ハイライト機能（日本語クリック → 原文に青下線）
- [ ] パスワード認証（Chapter 1 無料、全章は有料）
- [ ] EU AI Act 全113条コンテンツ投入
